...
def setup_product():
    ...
    import deliverance.contenttypes
    zcml.load_config('configure.zcml', deliverance.contenttypes)
    ...
    ztc.installPackage('deliverance.contenttypes')
...
setup_product()
ptc.setupPloneSite(products=['deliverance.contenttypes'])
